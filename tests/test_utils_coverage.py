    ...
    def test_display_find_results_no_matches(self):
        ...
        with patch('typer.secho') as mock_secho:
            ...
            mock_secho.assert_called_once_with(
                "No files found matching 'test'", err=True, fg="red"
            )
...
Content here""")
    ...
    def test_get_journal_template_vars_all_fields(self):
        ...
        expected_keys = {
            "year", "month", "day", "month_name", "month_abbr", "weekday", "weekday_abbr"
        }
    ...
    def test_list_all_metadata_empty(self):
        ...
        with patch('typer.secho') as mock_secho:
            ...
            mock_secho.assert_called_once_with("No frontmatter metadata found for this page", err=True, fg='red')
